...
<body>
    ...
    if (isset($_SESSION['usuario'])) {
        ...
        echo '<p class="bem-vindo">Bem-vindo, ' . $_SESSION['usuario'] . '</p>';
        echo '<a href="carrinho_session.php" class="visualizar-carrinho-btn">Visualizar Carrinho</a>';
        echo '</div>';
    } else {
        echo '<button class="entrar"><p>Entrar</p></button>';
    }
    ?>
</div>
    ...
    <div class="section-produtos">
        ...
        if ($resultado) {
            while ($produto = mysqli_fetch_assoc($resultado)) {
                ...
                echo "<a href='detalhes_produtos.php?ProdutoID=" . $produto['ProdutoID'] . "'>";
                ...
                echo '<a href="adicionar_carrinho.php?ProdutoID=' . $produto['ProdutoID'] . '" class="btn_adicionar">Adicionar ao Carrinho</a>';
                echo "</div>";
            }
        }
